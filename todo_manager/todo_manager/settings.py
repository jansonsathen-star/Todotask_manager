...
# Use BigAutoField by default to avoid Auto-created primary key warning
...
STATIC_URL = "/static/"
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "todolist", "templates", "static"),
]
# Where `collectstatic` will collect static files for production
STATIC_ROOT = os.path.join(BASE_DIR, "staticfiles")

# Optional: use WhiteNoise for simple static serving in production-like setups.
# Install via `pip install whitenoise` and uncomment middleware below.
